...
public class AdminController {
    ...
    public String actualizarEquipo(@ModelAttribute Equipo equipo, RedirectAttributes ra) {
        try {
            // mantenimientoDatosService.actualizarEquipo(equipo);
            ra.addFlashAttribute("exito", "Equipo actualizado correctamente");
        } catch (Exception e) {
            ra.addFlashAttribute("error", "Error al actualizar");
        }
        return "redirect:/mantenimiento/admin/equipos";
    }
}
